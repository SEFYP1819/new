...
public class US_Stock_Adapter extends ArrayAdapter<US_Stock> {

    public US_Stock_Adapter(@NonNull Context context, List<US_Stock> Data) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        convertView.findViewById(R.id.USStockList);
