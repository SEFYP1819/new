...
public class Inter_Bond_Adapter extends ArrayAdapter<Inter_Bond> {

    public Inter_Bond_Adapter(@NonNull Context context, List<Inter_Bond> Data) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        convertView.findViewById(R.id.InternationalBondsList);
