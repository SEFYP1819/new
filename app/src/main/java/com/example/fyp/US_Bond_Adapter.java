...
public class US_Bond_Adapter extends ArrayAdapter<US_Bond> {

    public US_Bond_Adapter(@NonNull Context context, List<US_Bond> Data) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        convertView.findViewById(R.id.USBondsList);
